...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 tv.py train --dataset=/path/to/tv/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 tv.py train --dataset=/path/to/tv/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 tv.py train --dataset=/path/to/tv/dataset --weights=imagenet

    # Apply color splash to an image
    python3 tv.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>

    # Apply color splash to video using the last weights you trained
    python3 tv.py splash --weights=last --video=<URL or path to file>
"""
